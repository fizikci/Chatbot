...
function speak(text, mood, language, success){
    ...
    speaking = true;
    responsiveVoice.speak(text, speakLangs[language || lang], {rate: mood.rate, volume:mood.volume, onend:function(){speaking=false; if(success) success();}});
...
var langs = {'turkish':'tr-TR', 'spanish':"es-ES", 'german':"de-DE", "french":"fr-FR", "italian":"it-IT", "russian":"ru-RU", "english":"en-US"};
